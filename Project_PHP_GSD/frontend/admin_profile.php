...
<head>
    ...
    <link rel="stylesheet" href="../styles/admin_profile.css" type="text/css">
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="admin_profile.php">Your admin profile</a>
                    </li>
                    <li class="nav-item">
    ...
    <main>
        <div class="container text-center"> 
         ...
         <div class="select-container">
            <form action="admin_profile.php" method="post";>
                <input type="radio" id="members" name="action" value="1">
                <label class="select-button" for="members">Members</label>
                <input type="radio" id="messages" name="action" value="2">
                <label class="select-button" for="messages">Messages</label>
                <button type="submit" id="option-select">Select</button>
            </form>
        </div>
        <?php
        if(isset( $_POST["action"])){
                ...
                if($option == 1){
                    require_once "../backend/members_display.php";?>
            ...
            <?php }
                ...
                if($option == 2){
                    require_once "../backend/messages_display.php";?>
                    <div class="table-container">
